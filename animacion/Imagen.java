 ...
 *	se lee desde un fichero con formato jpg, gif o png, y tambien se puede crear
 *	una imagen vacia de un tamano dado. La imagen puede guardarse en un fichero.
 *
 ******************************************************************************/
...
public final class Imagen  {
   ...
   /**
    ...
    public Imagen(int ancho, int alto) {
        if (ancho  < 0) throw new IllegalArgumentException("ancho no puede ser negativo");
        if (alto < 0) throw new IllegalArgumentException("alto no puede ser negativo");
        this.ancho  = ancho;
        this.alto = alto;
    ...
    /**
     * Crea una imagen a partir del  fichero que se pasa como parametro
     *
...
/**
   ...
   /**
    ...
    public Color getColor(int x, int y) {
        if (x < 0 || x >= ancho)  throw new IndexOutOfBoundsException("columan debe estar comprendido enre 0 y " + (ancho-1));
        if (y < 0 || y >= alto) throw new IndexOutOfBoundsException("rowdebe estar comprendido enre 0 y " + (alto-1));
    ...
    public void setColor(int x, int y, Color color) {
        if (x < 0 || x >= ancho)  throw new IndexOutOfBoundsException("column debe estar comprendido enre 0 y " + (ancho-1));
        if (y < 0 || y >= alto) throw new IndexOutOfBoundsException("row debe estar comprendido enre 0 y " + (alto-1));
        if (color == null) throw new NullPointerException("color no puede ser nulo");
